...
- [CLR的基本概念](./Csharp/CLR的基本概念.md)
- [CLR执行模型](./Csharp/CLR执行模型.md)

## 类型

- [类型基础](./Csharp/类型基础.md)
- [类型和成员](./Csharp/类型和成员.md)
- [泛型和接口](./Csharp/泛型和接口.md)


## 基本类型

- [字符,字符串和文本处理](./Csharp/字符,字符串和文本处理.md)
- [枚举和位标志](./Csharp/枚举和位标志.md)
- [数组](./Csharp/数组.md)
- [委托](./Csharp/委托.md)
- [事件](./Csharp/事件.md)
- [定制特性](./Csharp/定制特性.md)
...
- [异常和状态管理](./Csharp/异常和状态管理.md)
- [托管堆和垃圾回收](./Csharp/托管堆和垃圾回收.md)
- [CLR寄宿和APPDomain](./Csharp/CLR寄宿和AppDomain)
- [程序集加载和反射](./Csharp/程序集加载和反射.md)

## 程序集相关

- [什么是DLL Hell](https://stackoverflow.com/questions/1379287/i-keep-hearing-about-dll-hell-what-is-this)
- [什么是全局程序缓存](https://stackoverflow.com/questions/1268342/what-is-the-gac-in-net)


## C# 反射和特性
- [C# 的反射和特性](https://zhuanlan.zhihu.com/p/149528060)
- [获取不同程序集的类型的Type对象](https://stackoverflow.com/questions/3512319/resolve-type-from-class-name-in-a-different-assembly)
...
- [Linux 中的动态链接库和静态链接库是干什么的？ - wuxinliulei的回答 - 知乎](https://www.zhihu.com/question/20484931/answer/69553616])
- [window 和 Linux的动态链接库机制](https://www.bilibili.com/video/BV1fa411r7zp/?spm_id_from=333.788&vd_source=bb33286cda74be54bbcdf853e121e4f7/?t=0h25m14s)
